...
Edge A & 0.9859$\pm$0.0035 & 0.9871$\pm$0.0032 & 0.954$\pm$0.046 & 0.806$\pm$0.073 & 0.0010 & 0.0052 \\
Edge B & 0.9938$\pm$0.0036 & 0.9940$\pm$0.0031 & 0.979$\pm$0.020 & \textbf{0.879$\pm$0.033} & 0.0008 & \textbf{0.0005} \\
Federated & \textbf{0.9947$\pm$0.0019} & \textbf{0.9950$\pm$0.0017} & \textbf{0.980$\pm$0.022} & 0.865$\pm$0.059 & \textbf{0.0005} & 0.0007 \\ \bottomrule
\end{tabular}%
}
\end{table}
...
Table~\ref{tab:detection} and Fig.~\ref{fig:metrics} report the headline configuration. To account for run-to-run variance, we report mean $\pm$ standard deviation across eight initialisation seeds. The federated model achieves the highest average ROC-AUC (0.9947 $\pm$ 0.0019) and XSS recall (0.980 $\pm$ 0.022), matching the strongest silo (Edge~B) within the margin of error. On SQLi recall, Edge~B averages 0.879 against the federated 0.865, a difference again smaller than the standard deviation.

Federation's primary value is providing privacy at no measurable accuracy cost, while ensuring cross-domain generalisation. Edge~A alone produces a prohibitive 0.52\% false-positive rate on API traffic and reaches only 0.806 SQLi recall. After federation, its effective model lifts to 0.865 SQLi recall and zeros its cross-domain FPR, achieving the most balanced profile across both attack classes and both benign domains.
